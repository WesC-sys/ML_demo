...
# Edge Impulse library for EW-Anomaly-Detection-Thingy53

This is a C++ library that lets you run the impulse for "EW-Anomaly-Detection-Thingy53" (https://mlstudio.nordicsemi.com/studio/354224) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
