...
static const struct ml_result_led_effect ml_result_led_effects[] = {
	{
		.label = NULL,
		.effect = LED_EFFECT_LED_BLINK2(100, 500, LED_COLOR(10, 15, 10)),
	},
	{
		.label = ANOMALY_LABEL,
		.effect = LED_EFFECT_LED_BLINK2(200, 100, LED_COLOR(100, 0, 0)),
	},
	{
		.label = "speed_1",
	...
	{
		.label = "speed_3",
		.effect = LED_EFFECT_LED_ON(LED_COLOR(100, 100, 0)),
	},
};
